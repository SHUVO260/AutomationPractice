...
public class AmazonCase {
    ...
    @BeforeMethod
    public void driverLaunchUp() {
        System.setProperty("webdriver.chrome.driver", "lib\\webBrowser\\chromedriver.exe");
    ...
    public void searchBoxTypeAble() throws InterruptedException {
        driver.findElement(By.xpath("//*[@id=\"twotabsearchtextbox\"]")).clear();
        driver.findElement(By.xpath("//*[@id=\"twotabsearchtextbox\"]")).sendKeys("Oneplus 8 pro");
        Thread.sleep(3000);
